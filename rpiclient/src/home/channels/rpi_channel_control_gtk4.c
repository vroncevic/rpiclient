...
static void on_spinner_value_changed(GtkSpinButton *spin_button,
                                     gpointer user_data);
static void on_channel_check_box_toggled(GtkCheckButton *check_button,
                                         gpointer user_data);
...
static void on_scale_value_changed(GtkRange *range, gpointer user_data) {
  ...
  if (instance && !instance->is_updating) {
    ...
    if (gtk_check_button_get_active(
            GTK_CHECK_BUTTON(instance->control_channel_check_box))) {
...
RPIChannelControl *new_rpi_channel_control(gint channel_id) {
  ...
  g_snprintf(tooltip_text_spinner, sizeof(tooltip_text_spinner),
             "Set level at channel %d", channel_id - 1);
  gtk_widget_set_tooltip_text(
  ...
  gtk_check_button_set_active(
      GTK_CHECK_BUTTON(instance->control_channel_check_box), FALSE);
  ...
  gtk_box_append(GTK_BOX(hbox),
                 GTK_WIDGET(instance->control_channel_vertical_bar));
  gtk_box_append(GTK_BOX(hbox), GTK_WIDGET(instance->control_channel_scale));
  gtk_box_append(GTK_BOX(vbox), hbox);

  gtk_widget_set_halign(instance->control_channel_check_box, GTK_ALIGN_CENTER);
  gtk_box_append(GTK_BOX(vbox), instance->control_channel_check_box);

  gtk_widget_set_halign(instance->control_channel_spinner_button,
                        GTK_ALIGN_CENTER);
  gtk_box_append(GTK_BOX(vbox), instance->control_channel_spinner_button);
